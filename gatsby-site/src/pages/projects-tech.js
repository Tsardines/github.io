  ...
  <Layout>
    <h1>Projects</h1>
      <h3><a href="https://pc-wizard.herokuapp.com" target="_blank">PC Wizard</a></h3>
        <p>A minimalistic resource to help people build computers. Users can view information about different types of computer components, as well as information regarding specific computer parts (series, price, form factor, etc). <strong>Built with:</strong> Rails, Devise, and Bulma.</p>
